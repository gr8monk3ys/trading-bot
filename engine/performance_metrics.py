...
class PerformanceMetrics:
    ...
    def _calculate_annualized_return(self, total_return: float, start_date: datetime, end_date: datetime) -> float:
    ...
    def compare_strategies(self, results: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
        ...
        avg_ranks = {
            name: sum(ranks) / len(ranks) 
            for name, ranks in strategy_ranks.items()
        }
