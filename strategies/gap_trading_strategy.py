...
class GapTradingStrategy(BaseStrategy):
    ...
    async def initialize(self, **kwargs):
        ...
        try:
            ...
            logger.info(f"GapTradingStrategy initialized")
    ...
    async def _detect_gap(self, symbol: str) -> Optional[Dict]:
        ...
        try:
            ...
            is_tradeable = (
                abs(gap_pct) >= self.min_gap_pct and
                abs(gap_pct) <= self.max_gap_pct
            )
            ...
            return {
                ...
                'stop_price': open_price * (1 + self.stop_loss_pct) if gap_pct > 0 else open_price * (1 - self.stop_loss_pct),
            }
        ...
        try:
            ...
            if order:
                ...
                self.gap_trade_history.append({
                    ...
                    'hold_time': (datetime.now(self.tz) - trade['entry_time']).total_seconds() / 60,
                })
    ...
    def get_status(self) -> Dict:
        ...
        return {
            ...
            'trades_today': len([t for t in self.gap_trade_history
