...
live in ``strategies/mean_reversion/signals.py`` and are mixed in to keep
this module focused on lifecycle / order plumbing.
"""
...
class MeanReversionStrategy(MeanReversionSignalsMixin, BaseStrategy):
    """
