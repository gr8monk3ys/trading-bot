...
class TradingDashboard:
    ...
    async def render(self):
        ...
        try:
            ...
            print("-" * 100)
            print(
                f"  Equity: ${equity:>15,.2f}  |  Cash: ${cash:>15,.2f}  |  Buying Power: ${buying_power:>15,.2f}"
            )
            print(
                f"  Market: {'🟢 OPEN' if clock.is_open else '🔴 CLOSED':>16}  |  Day P/L: ${float(account.equity) - 100000:>+12,.2f}"
            )
            print("-" * 100)
            ...
            if positions:
                print(
                    f"{'Symbol':<8} {'Qty':>8} {'Entry':>10} {'Current':>10} {'Value':>12} {'P/L $':>12} {'P/L %':>10}"
                )
                print("-" * 100)
                for pos in positions:
                    ...
                    print(
                        f"{symbol:<8} {qty:>8.2f} ${entry:>9.2f} ${current:>9.2f} ${value:>11,.2f} "
            ...
            if recent_trades:
                ...
                for trade in reversed(recent_trades):
                    ...
                    reset = "\033[0m"
                    print(
                        f"{time_str:<20} {trade.symbol:<8} {trade.side:<6} "
