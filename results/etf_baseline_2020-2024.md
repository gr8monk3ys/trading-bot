...
> **Status: INCONCLUSIVE.** Strategy produced 38 trades, below the 50-trade significance bar (see `scripts/run_etf_baseline.py`). The numbers below are reported for transparency but must not be cited as evidence of strategy edge.
