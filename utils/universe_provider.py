...
class UniverseProvider:
    ...
    SP500_FALLBACK = [
        ...
        "LLY", "JPM", "XOM", "JNJ", "V", "PG", "MA", "AVGO", "HD", "CVX",
        "MRK", "ABBV", "COST", "PEP", "KO", "ADBE", "WMT", "MCD", "CSCO", "CRM",
        "BAC", "ACN", "TMO", "LIN", "ABT", "NFLX", "DHR", "ORCL", "AMD", "DIS",
        "PFE", "CMCSA", "VZ", "INTC", "PM", "WFC", "TXN", "COP", "NEE", "QCOM",
        # 51-100
        "INTU", "RTX", "AMAT", "BMY", "UPS", "HON", "CAT", "UNP", "LOW", "SPGI",
        "IBM", "T", "GE", "MS", "ELV", "BA", "SBUX", "DE", "GS", "BLK",
        "PLD", "NOW", "ISRG", "MDLZ", "GILD", "ADP", "AMT", "ADI", "BKNG", "SYK",
        "LMT", "TJX", "VRTX", "CI", "CVS", "REGN", "MMC", "CB", "C", "MO",
        "ZTS", "SO", "LRCX", "SCHW", "BSX", "PGR", "BDX", "FI", "TMUS", "DUK",
        # 101-150
        "SLB", "EOG", "ETN", "ICE", "PYPL", "CME", "AON", "MU", "SNPS", "NOC",
        "FCX", "KLAC", "EQIX", "APD", "SHW", "HUM", "ITW", "CL", "ORLY", "WM",
        "MCK", "CMG", "CDNS", "CSX", "PNC", "USB", "TGT", "EMR", "PSA", "NSC",
        "GD", "MAR", "MSI", "AJG", "APH", "MCO", "EW", "PH", "ATVI", "ECL",
        "TT", "ROP", "DXCM", "AZO", "OXY", "CTAS", "CARR", "MET", "TDG", "PCAR",
        # 151-200
        "WELL", "HLT", "AIG", "AFL", "HES", "COF", "STZ", "TRV", "PSX", "SRE",
        "ROST", "MCHP", "NEM", "AMP", "D", "PAYX", "KMB", "MSCI", "FTNT", "DHI",
        "IDXX", "TEL", "ODFL", "JCI", "FAST", "MNST", "CTSH", "SPG", "AEP", "O",
        "ALL", "CMI", "CPRT", "EA", "KHC", "YUM", "BIIB", "KEYS", "BK", "PRU",
        "AME", "VRSK", "HCA", "HSY", "A", "OTIS", "SYY", "DD", "PPG", "GWW",
        # 201-250
        "DOW", "FANG", "GEHC", "EXC", "CNC", "ILMN", "EL", "LHX", "XEL", "WMB",
        "GIS", "CBRE", "KDP", "MTD", "HIG", "IQV", "VLO", "NDAQ", "NUE", "KR",
        "RMD", "EIX", "ADM", "VICI", "WEC", "CTVA", "FTV", "ROK", "IT", "AWK",
        "ACGL", "ED", "OKE", "DG", "HAL", "PCG", "ANSS", "WST", "ON", "DLTR",
        "DLR", "VMC", "BKR", "DVN", "GLW", "CDW", "HPQ", "PWR", "EFX", "APTV",
    ]

    # NASDAQ-100 fallback
    NASDAQ100_FALLBACK = [
        "AAPL", "MSFT", "GOOGL", "GOOG", "AMZN", "NVDA", "META", "TSLA", "AVGO", "COST",
        "ADBE", "PEP", "CSCO", "NFLX", "AMD", "CMCSA", "INTC", "TMUS", "TXN", "QCOM",
        "INTU", "AMAT", "HON", "SBUX", "BKNG", "ISRG", "MDLZ", "GILD", "ADP", "ADI",
        "VRTX", "REGN", "LRCX", "PYPL", "MU", "SNPS", "KLAC", "CDNS", "CSX", "ORLY",
        "PANW", "MAR", "MELI", "FTNT", "MNST", "AZN", "DXCM", "CTAS", "PCAR", "PDD",
        "CPRT", "MCHP", "KHC", "ODFL", "EXC", "KDP", "PAYX", "CRWD", "AEP", "WDAY",
        "IDXX", "CEG", "ROST", "FAST", "MRNA", "ABNB", "ON", "CTSH", "EA", "BIIB",
        "ILMN", "BKR", "VRSK", "XEL", "CSGP", "GFS", "GEHC", "FANG", "ANSS", "DLTR",
        "WBD", "ZS", "TTD", "DDOG", "TEAM", "ALGN", "ENPH", "SIRI", "WBA", "LCID",
        "RIVN", "ZM", "OKTA", "SPLK", "DOCU", "NXPI", "EBAY", "JD", "ASML", "LULU",
    ]
