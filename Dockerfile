...
ARG TARGETARCH
RUN { wget --timeout=30 --tries=3 -q -O ta-lib-0.4.0-src.tar.gz "https://github.com/TA-Lib/ta-lib/releases/download/v0.4.0/ta-lib-0.4.0-src.tar.gz" || \
      wget --timeout=30 --tries=3 -q -O ta-lib-0.4.0-src.tar.gz "https://downloads.sourceforge.net/project/ta-lib/ta-lib/0.4.0/ta-lib-0.4.0-src.tar.gz"; } && \
